...
const commands = [
  ...
  { name: "review",      desc: "docs 品質チェック（章ファイルの構造検証）",                  usage: "[<docs-dir>]" },
  { name: "changelog",   desc: "specs/ から change_log.md を生成",                       usage: "[<output-file>]" },
  { name: "agents",      desc: "AGENTS.md の PROJECT セクションを更新（AI 要約）",       usage: "[--force] [--template]" },
